...
#Do not allow for an offet too high/negatives
    ...
    if(offset == 0):
      #A valid file must start and end with S and E
      if(data[0] == 'S' and data[len(data)-1] == 'E'):
        self.Bvalid = True
        pass
      else: 
        self.Bvalid = False
      ...
      fileSize = len(self.Afile.readat(None, 0))
      #log(fileSize)
...
#the reference monitor will create a valid backup file called filename.a and an empty file we will write to, called filename.b.
    ...
    #Check if filename.b was determined to be valid
    if(self.Bvalid == True):
      ...
      #log(replacementFile.readat(None, 0))
